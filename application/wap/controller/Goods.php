...
class Goods extends BaseController
{
    ...
    public function goodsDetail()
    {
        ...
        //VIP会员折扣价
        $goods_detail['price_'] = $goods_detail['price'];
        $goods_detail['promotion_price_'] = $goods_detail['promotion_price'];
        // $goods_detail['price'] = ismprice($this->uid,$goods_detail['goods_id']);
        // $goods_detail['promotion_price'] = ismprice($this->uid,$goods_detail['goods_id']);
        $goods_detail['price'] = getmprice($goods_detail['goods_id']);
        $goods_detail['promotion_price'] = getmprice($goods_detail['goods_id']);
        //print_r($goods_detail);exit;
        foreach ($goods_detail['sku_list'] as &$val)
        {
           $val['price_'] = $val['price'];
           $val['promote_price_'] = $val['promote_price'];
           // $val['price'] = ismprice($this->uid,$goods_detail['goods_id']);
           // $val['promote_price'] = ismprice($this->uid,$goods_detail['goods_id']);
           $val['price'] = getmprice($goods_detail['goods_id']);
           $val['promote_price'] = getmprice($goods_detail['goods_id']);
        }
    ...
    public function cart()
    {
        ...
        {
            $val['price'] = ismprice($val['buyer_id'],$val['goods_id']);
            $val['promotion_price'] = $val['price'];
        }
    ...
    public function goodsList()
    {
        ...
        if (request()->isAjax()) 
        {
            ...
            {
                $val['promotion_price_'] = $val['promotion_price'];
                //$val['promotion_price'] = ismprice($uid,$val['goods_id']);
                $val['promotion_price'] = getmprice($val['goods_id']);
                foreach ($val['sku_list'] as &$v)
                {
                    $v['promote_price_'] = $v['promote_price'];
                    //$v['promotion_price'] = ismprice($uid,$v['goods_id']);
                    $v['promotion_price'] = getmprice($v['goods_id']);
                    $v['price_'] = $v['price'];
                    $v['price'] = $v['promotion_price'];
                }
            }
