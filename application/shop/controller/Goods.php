...
class Goods extends BaseController
{
    ...
    public function goodsinfo($goodsid)
    {
        ...
        if (! empty($goodsid)) {
            ...
            //VIP折扣价格
            $goods_info['price']=ismprice($this->uid,$goods_info->goods_id);
            $goods_info['promotion_price']=ismprice($this->uid,$goods_info->goods_id);
            // $goods_info['price']=getmprice($goods_info->goods_id);
            // $goods_info['promotion_price']=getmprice($goods_info->goods_id);
            //js刷新了一个sku_id
            foreach ($goods_info['sku_list'] as &$val) 
            {
                $val['price'] = ismprice($this->uid,$goods_info->goods_id);
                $val['promote_price']=ismprice($this->uid,$goods_info->goods_id);
                // $val['price'] = getmprice($goods_info->goods_id);
                // $val['promote_price'] = getmprice($goods_info->goods_id);
            }
    ...
    public function cart()
    {
        ...
        {
            $val['price'] = ismprice($this->uid,$val['goods_id']);
            $val['promotion_price'] = ismprice($this->uid,$val['goods_id']);
        }
        ...
        //print_r(json_encode($goods_ladder_preferential));exit;
