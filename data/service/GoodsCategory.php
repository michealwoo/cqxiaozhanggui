...
class GoodsCategory extends BaseService implements IGoodsCategory
{
     ...
     */
    public function getGoodsCategoryBlockQuery($shop_id, $show_num = 20)
    {
        ...
        if (empty($cache)) 
        {
            ...
            foreach ($goods_category_block_list as $k => $v) 
            {
                ...
                $goods_list = $goods->getGoodsQueryLimit($condition, "ng.market_price,ng.goods_id,ng_sap.pic_cover_small,ng.goods_name,ng.promotion_price,ng.state,ng.shipping_fee,ng.group_id_array,ng.point_exchange_type,ng.point_exchange", $show_num, $order);
