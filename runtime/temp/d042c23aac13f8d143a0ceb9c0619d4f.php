<?php if (!defined('THINK_PATH')) exit(); /*a:16:{s:41:"template/wap/default_new/Index/index.html";i:1548487448;s:34:"template/wap/default_new/base.html";i:1550021569;s:38:"template/wap/default_new/urlModel.html";i:1545820113;s:35:"template/wap/default_new/share.html";i:1545820113;s:48:"template/wap/default_new/Index/controlSlide.html";i:1545820112;s:49:"template/wap/default_new/Index/controlSearch.html";i:1545820112;s:46:"template/wap/default_new/Index/controlNav.html";i:1546699054;s:49:"template/wap/default_new/Index/controlNotice.html";i:1545820112;s:49:"template/wap/default_new/Index/controlCoupon.html";i:1545820112;s:56:"template/wap/default_new/Index/controlPromotionGame.html";i:1545820112;s:52:"template/wap/default_new/Index/controlFigureAdv.html";i:1545820112;s:51:"template/wap/default_new/Index/controlDiscount.html";i:1545820112;s:46:"template/wap/default_new/controlCopyRight.html";i:1548687272;s:82:"template/wap/default_new/CustomTemplate/controlCommonCustomTemplateBaseFooter.html";i:1545820112;s:36:"template/wap/default_new/footer.html";i:1548421492;s:43:"template/wap/default_new/shareContents.html";i:1545820113;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function updateEndTime() {
	...
	<?php if(!(empty($index_adv_one) || (($index_adv_one instanceof \think\Collection || $index_adv_one instanceof \think\Paginator ) && $index_adv_one->isEmpty()))): if($index_adv_one['is_use'] == 1): if($index_adv_one['adv_list'][0]['adv_image'] != ''): ?>
		<div class="common_image">
			<a href="<?php echo $index_adv_one['adv_list'][0]['adv_url']; ?>">
			   <img src="<?php echo __IMG($index_adv_one['adv_list'][0]['adv_image']); ?>" alt="" class="img_common">
			</a>
		</div>
		<?php endif; endif; endif; ?>
					...
					<li class="gooditem">
						...
						<div class="info">
							...
							<div class="goods-info">
								...
								￥<?php echo $goods['promotion_price']; ?></em></span>
							...
							<div class="info">
								...
								<div class="goods-info">
									<span class="goods_price">
										...
										<label style="font-size: 12px;text-decoration: line-through;">会员价:</label><em style="color: #fb3a2f;text-decoration: line-through;">￥<?php echo $list['promotion_price_']; ?></em>
...
<div class="fixed bottom">
	...
	<dl class="sub-nav nav-b5">
		...
		<dd id="bottom_classify">
			<a href="<?php echo __URL('APP_MAIN/goods/goodslist'); ?>">
				<div class="nav-b5-relative">
					<img src="__TEMP__/<?php echo $style; ?>/public/images/classify_uncheck.png"/>
					<span><?php echo lang('category'); ?></span>
				</div>
		...
		<!-- 'pay/payvip&uid='.$this->uid -->
		<?php if($isvip == 0): ?>
		<dd id="bottom_vip">
			<a href="<?php echo __URL('APP_MAIN/pay/payvip&uid='.$uid); ?>">
				<div class="nav-b5-relative">
					<img src="__TEMP__/<?php echo $style; ?>/public/images/vip.png"/>
					<span>VIP</span>
				</div>
			</a>
		</dd>
