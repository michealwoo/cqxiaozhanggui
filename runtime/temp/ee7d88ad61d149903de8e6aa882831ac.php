											...
											<div class="thumb_name">
												<dl>
													<dt> 
														...
														<img src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($cart_info['picture_info']['pic_cover_small']); ?>" border="0" title="<?php echo $cart_info['goods_name']; ?>">
														</a>
													</dt>
													<dd>
