...
<div class="template-message">短信通知模板</div>
	<div class="tab-pane active">
		...
		<div class="right_main">
			...
			<div class="qianming"><div style="width:75px;float:left;">模板ID：</div><input type="text" id="template_titleid" value="<?php echo $template_select['template_title']; ?>" style="margin-right: 15px !important;" class="input-common" /><span style="font-size:13px;">必须与阿里大于的模板ID一致，否则无效!</span></div>
			<div class="qianming"><div style="width:75px;float:left;">短信签名：</div><input type="text" id="signNameid" style="margin-right: 15px !important;" value="<?php echo $template_select['sign_name']; ?>" class="input-common" /><span style="font-size:13px;">与阿里大于内短信签名保持一致!</span></div>
			<div class="bl">
