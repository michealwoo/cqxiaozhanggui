...
<div class="set-style">
	...
	<dl>
		<dt>APP_KEY：</dt>
		<dd>
			<input id="app_key" type="text" value="<?php echo $mobile_message['value']['appKey']; ?>" class="input-common long" />
		</dd>
	</dl>
	<dl>
		<dt>SECRET_KEY：</dt>
		<dd>
			<input id="secret_key" type="text" value="<?php echo $mobile_message['value']['secretKey']; ?>" class="input-common long" />
		</dd>
	</dl>
	<dl>
		<dt>短信内容签名：</dt>
		<dd>
			<input id="free_sign_name" type="text" value="<?php echo $mobile_message['value']['freeSignName']; ?>" class="input-common long" />
		</dd>
	</dl>
	<dl>
		<dt>阿里大于用户：</dt>
		<dd class="user_type">
			...
			<label class="radio inline normal">
				<i class="radio-common <?php if($mobile_message['value']['user_type'] == 0): ?>selected<?php endif; ?>"><input type="radio" value="0" name="user_type" id="user_type_old" <?php if($mobile_message['value']['user_type'] == 0): ?>checked="checked"<?php endif; ?> /></i>
				<span>旧用户</span>
			</label>
			<label class="radio inline normal">
				<i class="radio-common <?php if($mobile_message['value']['user_type'] == 1): ?>selected<?php endif; ?>"><input type="radio" value="1" name="user_type" id="user_type_new" <?php if($mobile_message['value']['user_type'] == 1): ?>checked="checked"<?php endif; ?> /></i>
				<span>新用户</span>
			</label>
