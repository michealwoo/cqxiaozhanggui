<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"template/wap/default_new/Member/addMemberAddress.html";i:1545820112;s:34:"template/wap/default_new/base.html";i:1550021569;s:38:"template/wap/default_new/urlModel.html";i:1545820113;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="form-info">
	...
	<div class="div-item">
		<span><?php echo lang('member_fixed_telephone'); ?></span> <input type="text" id="phone" placeholder="<?php echo lang('member_fixed_telephone'); ?>（选填）" />
	</div>
	<div class="div-item">
