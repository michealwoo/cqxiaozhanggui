<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"template/wap/default_new/Pay/getPayVipValue.html";i:1546439493;s:34:"template/wap/default_new/base.html";i:1549107352;s:38:"template/wap/default_new/urlModel.html";i:1545820113;s:46:"template/wap/default_new/controlCopyRight.html";i:1548687272;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="pay-type-item">
	<div class="codes">
		...
		<input type="hidden" id="uid" value="<?php echo $pay_value['uid']; ?>">
	</div>
</div>
...
function calculate()
{
	...
	//微信支付
	window.location.href = __URL("APP_MAIN/pay/vipwechatpay?out_trade_no=" + out_trade_no + "&uid=" + uid);
}
