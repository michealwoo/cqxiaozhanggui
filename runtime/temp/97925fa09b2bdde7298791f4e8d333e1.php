<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:39:"template/adminblue/Goods/editGoods.html";i:1548411778;s:28:"template/adminblue/base.html";i:1545820112;s:45:"template/adminblue/controlCommonVariable.html";i:1545820112;s:61:"template/adminblue/Goods/controlEditGoodsCommonResources.html";i:1545820112;s:32:"template/adminblue/urlModel.html";i:1545820112;s:58:"template/adminblue/Goods/controlEditGoodsCommonScript.html";i:1545820112;s:42:"template/adminblue/Goods/fileAlbumImg.html";i:1545820112;s:34:"template/adminblue/pageCommon.html";i:1545820112;s:34:"template/adminblue/openDialog.html";i:1545820112;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="ncsc-form-goods">
	...
	<div class="block-basic-setting">
		...
		<dl>
			<dt>商品编码：</dt>
			<dd>
				<input type="text" class="input-common" id="txtProductCodeA" placeholder="请输入商品编码" <?php if($goods_info): ?>value="<?php echo $goods_info['code']; ?>"<?php endif; ?>/>
				<span class="help-inline">请输入商品编码，不能超过40个字符</span>
			</dd>
		</dl>
		<dl>
			<dt>生产日期：</dt>
		...
		<dl>
			<dt><i class="required">*</i>VIP价格：</dt>
			<dd>
				<input class="goods_price input-common harf" type="number" id="txtProductMprice" <?php if($goods_info): ?>value="<?php echo $goods_info['mprice']; ?>"<?php endif; ?> min="0" placeholder="0.00" 
				/><em class="unit">元</em>
				<span class="help-inline">VIP会员价格不能为空，且不能为负数</span>
			</dd>
		</dl>
		<dl>
			<dt>成本价格：</dt>
...
<!-- 			<button class="btn-common-white js-batch-edit-sku">批量修改</button> -->
		...
		<div class="volume-set-sku-info">
			...
			<a href="javascript:;" data-tag="sku-price">会员价格</a>
			<a href="javascript:;" data-tag="mprice">VIP价格</a>
	...
	<!-- 编辑规格价格、库存、商品编码信息 -->
		<table class="table-class">
			...
			<tr>
				...
				<td>
					<input type="text" class="input-common js-sku-price middle" placeholder="会员价格" />
				</td>
				<td>
					<input type="text" class="input-common js-mprice middle" placeholder="VIP价格" />
				</td>
				<td>
